...
## Currently broken, wait until I'll fully test it (desync of file version & laziness lead to major errors in both this project and discord_api then I tried to dump part of the guild)
